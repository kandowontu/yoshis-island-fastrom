...
CODE_028183:
  ...
  PLA                                       ; $028188 |
  JML despawn_sprite_stage_ID               ; $028189 |
...
init_roger:
  ...
  JML despawn_sprite_stage_ID               ; $028495 |
...
CODE_0285A2:
  ...
  STA $02                                   ; $0285D1 |
  jsl $82E1A3                               ; $0285D3 |
  JML despawn_sprite_free_slot              ; $0285D7 |
...
CODE_028906:
  ...
  STA $02                                   ; $028916 |
  jsl $8D8ED7                               ; $028918 |
  JSL despawn_sprite_free_slot              ; $02891C |
  PLA                                       ; $028920 |
...
CODE_029161:
  ...
  JML despawn_sprite_stage_ID               ; $029173 |
...
transform_enemies:
  ...
  jsl $829507                               ; $0294AA |
  LDX $12                                   ; $0294AE |
  JSL despawn_sprite_free_slot              ; $0294B0 |
...
CODE_0295F8:
  ...
  STZ $61BE                                 ; $029610 |
  JML despawn_sprite_stage_ID               ; $029613 |
...
CODE_02991D:
  ...
  LDA #$0027                                ; $029943 |\ play sound #$27
  JSL push_sound_queue                      ; $029946 |/
  JSL despawn_sprite_stage_ID               ; $02994A |
...
CODE_0299C6:
  ...
  jsl $84EF27                               ; $029A0F |
  SEP #$10                                  ; $029A13 |
  JSL despawn_sprite_stage_ID               ; $029A15 |
  PHX                                       ; $029A19 |
  LDA #$0029                                ; $029A1A |
  LDY #$00                                  ; $029A1D |
  TYX                                       ; $029A1F |
...
CODE_029A9B:
  ...
  JSL despawn_sprite_stage_ID               ; $029ABE |
...
CODE_029B85:
  ...
  JSL despawn_sprite_stage_ID               ; $029BA6 |
  LDA #$0100                                ; $029BAA |
...
init_falling_rock:
  ...
  STZ $61C0                                 ; $029CA7 |
  JML despawn_sprite_stage_ID               ; $029CAA |
...
CODE_029D97:
  JML despawn_sprite_stage_ID               ; $029D97 |
...
CODE_029EC4:
  JML despawn_sprite_free_slot              ; $029EC4 |
...
CODE_029F9E:
  ...
  JML despawn_sprite_free_slot              ; $029FC3 |
...
CODE_02A08C:
  ...
  JML despawn_sprite_stage_ID               ; $02A094 |
...
CODE_02A782:
  JML despawn_sprite_stage_ID               ; $02A782 |
...
CODE_02A786:
  ...
  TXY                                       ; $02A789 |
  TAX                                       ; $02A78A |
  JSR (goal_ptr,x)                          ; $02A78B | goal_ptr
...
CODE_02A7A3:
  ...
  LDA goal_sounds,y                         ; $02A7B7 | | play goal sounds from table (#$51 up to #$55)
...
CODE_02AC31:
  ...
  DEY                                       ; $02AC42 |
  TYX                                       ; $02AC43 |
  JSL despawn_sprite_stage_ID               ; $02AC44 |
  LDX $12                                   ; $02AC48 |
  JSL despawn_sprite_stage_ID               ; $02AC4A |
...
CODE_02ADFD:
  ...
  JML despawn_sprite_stage_ID               ; $02AE02 |
...
CODE_02B852:
  TYX                                       ; $02B852 |
  JSL despawn_sprite_stage_ID               ; $02B853 |
  LDX $12                                   ; $02B857 |
  PLA                                       ; $02B859 |
  PLA                                       ; $02B85A |
  RTL                                       ; $02B85B |
...
CODE_02C7FF:
  ...
  JML despawn_sprite_stage_ID               ; $02C810 |
...
CODE_02C89D:
  JML despawn_sprite_stage_ID               ; $02C89D |
...
CODE_02C931:
  PHY                                       ; $02C931 |
  LDX $7DF6,y                               ; $02C932 |
  JSL despawn_sprite_free_slot              ; $02C935 |
  PLY                                       ; $02C939 |
  DEY                                       ; $02C93A |
  DEY                                       ; $02C93B |
...
CODE_02CDE1:
  ...
  LDA $10                                   ; $02CDE6 |
  AND #$0001                                ; $02CDE8 |\
  CLC                                       ; $02CDEB | | play sound #$47 or #$0048
  ADC #$0047                                ; $02CDEC | |
...
CODE_02D0AE:
  ...
  LDA #$0002                                ; $02D0CE |
  STA $7782,y                               ; $02D0D1 |
  JML despawn_sprite_stage_ID               ; $02D0D4 |
...
CODE_02D765:
  ...
  STA $02                                   ; $02D76D |
  jsl $82E19C                               ; $02D76F |
  JSL despawn_sprite_free_slot              ; $02D773 |
...
CODE_02DF29:
  ...
  JSL despawn_sprite_stage_ID               ; $02DF4E |
...
CODE_02E0C4:
  JML despawn_sprite_stage_ID               ; $02E0C4 |
...
; boss explosion sub
  JSL despawn_sprite_free_slot              ; $02E191 |
  LDA #$0014                                ; $02E195 |
...
CODE_02EA2B:
  ...
  STZ $7ECC                                 ; $02EA7A |
  PLA                                       ; $02EA7D |
  JML despawn_sprite_free_slot              ; $02EA7E |
...
CODE_02F30F:
  ...
  STZ $7ECC                                 ; $02F316 |
  PLA                                       ; $02F319 |
  JML despawn_sprite_free_slot              ; $02F31A |
