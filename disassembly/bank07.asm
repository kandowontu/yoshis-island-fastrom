...
CODE_078495:
  ...
  REP #$20                                  ; $078511 |
  PLA                                       ; $078513 |
  JML despawn_sprite_free_slot              ; $078514 |
...
init_poochy:
  ...
  JML despawn_sprite_stage_ID               ; $07962D |
...
main_poochy:
  ...
  JML despawn_sprite_stage_ID               ; $079648 |
...
CODE_079791:
  ...
  LDA #$00A2                                ; $0797B0 |\
  JSL push_sound_queue                      ; $0797B3 |/ play sound #$A2
...
CODE_0797C6:
  ...
  LDA #$00A2                                ; $0797E6 |\
  JSL push_sound_queue                      ; $0797E9 |/ play sound #$A2
...
CODE_07A022:
  ...
  TYX                                       ; $07A038 |
  JSL despawn_sprite_stage_ID               ; $07A039 |
  LDX $12                                   ; $07A03D |
...
CODE_07A3EF:
  ...
  LDA #$0020                                ; $07A465 |\ play sound #$20
  JSL push_sound_queue                      ; $07A468 |/
  LDA #$004A                                ; $07A46C |\ play sound #$4A
...
CODE_07A5CA:
  LDA #$003B                                ; $07A5CA |\ play sound #$3B
  JSL push_sound_queue                      ; $07A5CD |/
  jsl $8CFF61                               ; $07A5D1 |
  JSL despawn_sprite_free_slot              ; $07A5D5 |
  LDA #$0004                                ; $07A5D9 |
  STA $00                                   ; $07A5DC |
...
init_lakitu:
  ...
  JML despawn_sprite_stage_ID               ; $07A67F |
...
init_fat_guy:
  ...
  JML despawn_sprite_stage_ID               ; $07ADFB |
...
CODE_07B227:
  JML despawn_sprite_stage_ID               ; $07B227 |
...
CODE_07BE86:
  ...
  PLY                                       ; $07BE89 |
  PLA                                       ; $07BE8A |
  JML despawn_sprite_stage_ID               ; $07BE8B |
...
CODE_07C39D:
  ...
  DEC $0C4E                                 ; $07C3B8 |
  JML despawn_sprite_stage_ID               ; $07C3BB |
...
CODE_07C4DF:
  DEC $0C4E                                 ; $07C4DF |
  JML despawn_sprite_stage_ID               ; $07C4E2 |
...
CODE_07C688:
  ...
  DEC $0C4E                                 ; $07C69A |
  JML despawn_sprite_stage_ID               ; $07C69D |
...
init_spear_guy_dancing:
  ...
  JML despawn_sprite_stage_ID               ; $07C972 |
...
CODE_07D7F6:
  jsl $83B20B                               ; $07D7F6 |
  LDA #$001C                                ; $07D7FA |\
  JSL push_sound_queue                      ; $07D7FD |/ play sound #$1C
...
CODE_07D91E:
  ...
  JSL despawn_sprite_stage_ID               ; $07D951 |
...
CODE_07D9EA:
  jsl $87FC2F                               ; $07D9EA | BUG_double_shell_stomp
...
CODE_07DB3F:
  TYX                                       ; $07DB3F |
  jsl $8CFF61                               ; $07DB40 |
  JSL despawn_sprite_free_slot              ; $07DB44 |
  LDX $12                                   ; $07DB48 |
...
CODE_07DFA4:
  ...
  PLX                                       ; $07DFE7 |
  JSL despawn_sprite_stage_ID               ; $07DFE8 |
  LDX $12                                   ; $07DFEC |
  RTS                                       ; $07DFEE |
...
CODE_07F28B:
  ...
  PLA                                       ; $07F291 |
  JML despawn_sprite_stage_ID               ; $07F292 |
...
CODE_07F974:
  ...
  JSL despawn_sprite_free_slot              ; $07F97D |
  RTS                                       ; $07F981 |
...
CODE_07FB8B:
  ...
  LDX $12                                   ; $07FBA5 |
  LDA #$003B                                ; $07FBA7 |\
  JSL push_sound_queue                      ; $07FBAA |/ play sound #$3B
  LDA #$01EF                                ; $07FBAE |
  ...
  STA $7142,y                               ; $07FBCA |
  PLA                                       ; $07FBCD |
  JML despawn_sprite_free_slot              ; $07FBCE |
...
CODE_07FC54:
  ...
  PLY                                       ; $07FC5D |
  PLA                                       ; $07FC5E |
  JML despawn_sprite_stage_ID               ; $07FC5F |
...
init_cork:
  ...
  JML despawn_sprite_stage_ID               ; $07FDDC |
