...
CODE_06805C:
  JML despawn_sprite_stage_ID               ; $06805C |
...
CODE_06814F:
  ...
  ADC $00                                   ; $0681BE |
  TAX                                       ; $0681C0 |
  LDA hirom_mirror($18B3F2),x               ; $0681C1 |
  STA $04                                   ; $0681C5 |
  LDA hirom_mirror($18B3F4),x               ; $0681C7 |
  STA $06                                   ; $0681CB |
  LDA hirom_mirror($18B3F6),x               ; $0681CD |
  STA $08                                   ; $0681D1 |
  LDA hirom_mirror($18B3F8),x               ; $0681D3 |
  STA $0A                                   ; $0681D7 |
  SEP #$10                                  ; $0681D9 |
  PLY                                       ; $0681DB |
  LDX $12                                   ; $0681DC |
...
CODE_06836F:
  LDA hirom_mirror($3FE344),x               ; $06836F |
  STA $702D74,x                             ; $068373 |
  STA $702008,x                             ; $068377 |
  DEX                                       ; $06837B |
  DEX                                       ; $06837C |
...
CODE_0685F2:
  LDA hirom_mirror($3FA56E),x               ; $0685F2 |
  STA $7020C0,x                             ; $0685F6 |
  STA $7020E0,x                             ; $0685FA |
  DEX                                       ; $0685FE |
  DEX                                       ; $0685FF |
...
CODE_068605:
  LDA hirom_mirror($3FE9C6),x               ; $068605 |
  STA $702E2C,x                             ; $068609 |
  STA $7020C0,x                             ; $06860D |
  LDA hirom_mirror($3FE9E2),x               ; $068611 |
  STA $702E4C,x                             ; $068615 |
  STA $7020E0,x                             ; $068619 |
  DEX                                       ; $06861D |
  DEX                                       ; $06861E |
...
; salvo main $0B
  ...
  STZ $7ECC                                 ; $068C9E |
  PLA                                       ; $068CA1 |
  JML despawn_sprite_free_slot              ; $068CA2 |
...
CODE_068CBF:
  ...
  LDA #$0006                                ; $068CF1 |
  STA $7782,y                               ; $068CF4 |
  JSL despawn_sprite_stage_ID               ; $068CF7 |
  LDA #$001C                                ; $068CFB |\ play sound #$1C
...
; args to $00BE39
  ...
  LDX $12                                   ; $068D5D |
  PLA                                       ; $068D5F |
  JML despawn_sprite_free_slot              ; $068D60 |
...
CODE_0690D2:
  REP #$10                                  ; $0690D2 |
  LDX $107C                                 ; $0690D4 |
  LDA hirom_mirror($3FA1A8),x               ; $0690D7 |
  STA $702018                               ; $0690DB |
  STA $702D84                               ; $0690DF |
  LDA hirom_mirror($3FA1AA),x               ; $0690E3 |
  STA $70201A                               ; $0690E7 |
  STA $702D86                               ; $0690EB |
  LDA hirom_mirror($3FA1AC),x               ; $0690EF |
  STA $70201C                               ; $0690F3 |
  STA $702D88                               ; $0690F7 |
  LDA hirom_mirror($3FA1AE),x               ; $0690FB |
  STA $70201E                               ; $0690FF |
  STA $702D8A                               ; $069103 |
  TXA                                       ; $069107 |
  CLC                                       ; $069108 |
...
CODE_069624:
  ...
  STZ $617C                                 ; $06963B |
  PLA                                       ; $06963E |
  JML despawn_sprite_free_slot              ; $06963F |
...
CODE_06974E:
  ...
  STZ $1015                                 ; $069755 |
  INC $105A                                 ; $069758 |
  JSL despawn_sprite_stage_ID               ; $06975B |
...
CODE_069BD6:
  LDA hirom_mirror($3FE640),x               ; $069BD6 |
  STA $702E2E,x                             ; $069BDA |
  STA $7020C2,x                             ; $069BDE |
  DEX                                       ; $069BE2 |
  DEX                                       ; $069BE3 |
...
CODE_06A304:
  ...
  JML despawn_sprite_free_slot              ; $06A30A |
  RTL                                       ; $06A30E |
...
CODE_06A947:
  ...
  dl hirom_mirror($3FA570)                  ; $06A948 |
  dl $702E2E                                ; $06A94B |
  dl $702E2E                                ; $06A94E |
  dl $702E2E                                ; $06A951 |
  dl hirom_mirror($3FA570)                  ; $06A954 |
  dl $702E4E                                ; $06A957 |
  dl $702E4E                                ; $06A95A |
  dl $702E4E                                ; $06A95D |
  dl hirom_mirror($3FA570)                  ; $06A960 |
  dl $702F2E                                ; $06A963 |
  dl $702F2E                                ; $06A966 |
  dl $702F2E                                ; $06A969 |
  dl hirom_mirror($3FA570)                  ; $06A96C |
  dl $702F4E                                ; $06A96F |
  dl $702F4E                                ; $06A972 |
  dl $702F4E                                ; $06A975 |
...
init_marching_milde:
  ...
  jsl $8CE5D6                               ; $06AA51 |
  LDX $12                                   ; $06AA55 |
  JML despawn_sprite_free_slot              ; $06AA57 |
...
CODE_06AB63:
  JML despawn_sprite_free_slot              ; $06AB63 |
...
CODE_06ABB1:
  LDA hirom_mirror($3FE6BC),x               ; $06ABB1 |
  STA $702E4E,x                             ; $06ABB5 |
  STA $7020E2,x                             ; $06ABB9 |
  DEX                                       ; $06ABBD |
  DEX                                       ; $06ABBE |
...
init_12E:
  ...
  dl hirom_mirror($3FD98A)                  ; $06B934 |
  dl hirom_mirror($3FD984)                  ; $06B937 |
  dl hirom_mirror($3FD986)                  ; $06B93A |
  dl hirom_mirror($3FD988)                  ; $06B93D |
...
CODE_06B9B8:
  ...
  JML despawn_sprite_stage_ID               ; $06B9BE |
...
CODE_06BE8F:
  ...
  STZ $0D9C                                 ; $06BEAF |
  LDA #$003D                                ; $06BEB2 |\ play sound #$3D
  JSL push_sound_queue                      ; $06BEB5 |/
  RTL                                       ; $06BEB9 |

  LDA #$003D                                ; $06BEBA |\ play sound #$3D
...
CODE_06C281:
  ...
  LDX $18                                   ; $06C296 |
  JSL despawn_sprite_stage_ID               ; $06C298 |
  LDX $12                                   ; $06C29C |
  jsl $86C114                               ; $06C29E |
...
CODE_06D1F4:
  JSL despawn_sprite_stage_ID               ; $06D1F4 |
  LDA $0E                                   ; $06D1F8 |
  BIT #$0010                                ; $06D1FA |
...
CODE_06D9F2:
  JSL despawn_sprite_stage_ID               ; $06D9F2 |
...
CODE_06E080:
  JSL despawn_sprite_stage_ID               ; $06E080 |
...
CODE_06E48B:
  ...
  jsl $80BE39                               ; $06E4EB | continues 8 bytes later
...
CODE_06E987:
  JSL despawn_sprite_stage_ID               ; $06E987 |
  RTL                                       ; $06E98B |
...
; uncompressed graphics files
  dl hirom_mirror($248000)                  ; $06F91F |
  dl hirom_mirror($258000)                  ; $06F922 |
  dl hirom_mirror($25C000)                  ; $06F925 |
  dl hirom_mirror($268000)                  ; $06F928 |
  dl hirom_mirror($278000)                  ; $06F92B |
  dl hirom_mirror($27C000)                  ; $06F92E |
  dl hirom_mirror($288000)                  ; $06F931 |
  dl hirom_mirror($298000)                  ; $06F934 |
  dl hirom_mirror($2A8000)                  ; $06F937 |
  dl hirom_mirror($2B8000)                  ; $06F93A |
  dl hirom_mirror($2C8000)                  ; $06F93D |
  dl hirom_mirror($2CE000)                  ; $06F940 |
  dl hirom_mirror($2D8000)                  ; $06F943 |
  dl hirom_mirror($2D9000)                  ; $06F946 |
  dl hirom_mirror($2DA000)                  ; $06F949 |
  dl hirom_mirror($2DB000)                  ; $06F94C |
  dl hirom_mirror($2DC000)                  ; $06F94F |
  dl hirom_mirror($2DD000)                  ; $06F952 |
  dl hirom_mirror($2DE800)                  ; $06F955 |
  dl hirom_mirror($2DEC00)                  ; $06F958 |
  dl hirom_mirror($2DFC00)                  ; $06F95B |

; compression routine $08A980 graphics files
  dl hirom_mirror($2EBC00)                  ; $06F95E |
  dl hirom_mirror($2EC8E9)                  ; $06F961 |
  dl hirom_mirror($2ED55B)                  ; $06F964 |
  dl hirom_mirror($2EE234)                  ; $06F967 |
  dl hirom_mirror($2EEEAB)                  ; $06F96A |
  dl hirom_mirror($2EF8F9)                  ; $06F96D |
  dl hirom_mirror($2F826C)                  ; $06F970 |
  dl hirom_mirror($2F8DB8)                  ; $06F973 |
  dl hirom_mirror($2F9952)                  ; $06F976 |
  dl hirom_mirror($2FA56A)                  ; $06F979 |
  dl hirom_mirror($2FAECB)                  ; $06F97C |
  dl hirom_mirror($2FB9B0)                  ; $06F97F |
  dl hirom_mirror($2FC271)                  ; $06F982 |
  dl hirom_mirror($2FCEA1)                  ; $06F985 |
  dl hirom_mirror($2FDBBA)                  ; $06F988 |
  dl hirom_mirror($2FE85A)                  ; $06F98B |
  dl hirom_mirror($2FF3C7)                  ; $06F98E |
  dl hirom_mirror($2FF85E)                  ; $06F991 |
  dl hirom_mirror($2FFDEA)                  ; $06F994 |
  dl hirom_mirror($30825D)                  ; $06F997 |
  dl hirom_mirror($3083E1)                  ; $06F99A |
  dl hirom_mirror($3088D6)                  ; $06F99D |
  dl hirom_mirror($308C65)                  ; $06F9A0 |
  dl hirom_mirror($308FCD)                  ; $06F9A3 |
  dl hirom_mirror($3094E1)                  ; $06F9A6 |
  dl hirom_mirror($309B2C)                  ; $06F9A9 |
  dl hirom_mirror($309FDA)                  ; $06F9AC |
  dl hirom_mirror($30A2D0)                  ; $06F9AF |
  dl hirom_mirror($30A85E)                  ; $06F9B2 |
  dl hirom_mirror($30AFC1)                  ; $06F9B5 |
  dl hirom_mirror($30B5E2)                  ; $06F9B8 |
  dl hirom_mirror($30BC34)                  ; $06F9BB |
  dl hirom_mirror($30C016)                  ; $06F9BE |
  dl hirom_mirror($30C51B)                  ; $06F9C1 |
  dl hirom_mirror($30CA74)                  ; $06F9C4 |
  dl hirom_mirror($30CFBF)                  ; $06F9C7 |
  dl hirom_mirror($30DA68)                  ; $06F9CA |
  dl hirom_mirror($30E597)                  ; $06F9CD |
  dl hirom_mirror($30F20F)                  ; $06F9D0 |
  dl hirom_mirror($30FE21)                  ; $06F9D3 |
  dl hirom_mirror($3183AF)                  ; $06F9D6 |
  dl hirom_mirror($3188CD)                  ; $06F9D9 |
  dl hirom_mirror($318E8F)                  ; $06F9DC |
  dl hirom_mirror($319574)                  ; $06F9DF |
  dl hirom_mirror($319AE6)                  ; $06F9E2 |
  dl hirom_mirror($319D4F)                  ; $06F9E5 |
  dl hirom_mirror($319FC4)                  ; $06F9E8 |
  dl hirom_mirror($31A2CD)                  ; $06F9EB |
  dl hirom_mirror($31A5D2)                  ; $06F9EE |
  dl hirom_mirror($31B241)                  ; $06F9F1 |
  dl hirom_mirror($31BE20)                  ; $06F9F4 |
  dl hirom_mirror($31C992)                  ; $06F9F7 |
  dl hirom_mirror($31D774)                  ; $06F9FA |
  dl hirom_mirror($31E471)                  ; $06F9FD |
  dl hirom_mirror($31EE33)                  ; $06FA00 |
  dl hirom_mirror($31F928)                  ; $06FA03 |
  dl hirom_mirror($3282AB)                  ; $06FA06 |
  dl hirom_mirror($328E7D)                  ; $06FA09 |
  dl hirom_mirror($329A64)                  ; $06FA0C |
  dl hirom_mirror($32A757)                  ; $06FA0F |
  dl hirom_mirror($32B432)                  ; $06FA12 |
  dl hirom_mirror($32C1AC)                  ; $06FA15 |
  dl hirom_mirror($32CE69)                  ; $06FA18 |
  dl hirom_mirror($32D892)                  ; $06FA1B |
  dl hirom_mirror($32E4EC)                  ; $06FA1E |
  dl hirom_mirror($32F241)                  ; $06FA21 |
  dl hirom_mirror($32FF14)                  ; $06FA24 |
  dl hirom_mirror($338ABB)                  ; $06FA27 |
  dl hirom_mirror($3396AF)                  ; $06FA2A |
  dl hirom_mirror($339C37)                  ; $06FA2D |
  dl hirom_mirror($33A7C1)                  ; $06FA30 |
  dl hirom_mirror($33B3E4)                  ; $06FA33 |
  dl hirom_mirror($33C08B)                  ; $06FA36 |
  dl hirom_mirror($33CD17)                  ; $06FA39 |
  dl hirom_mirror($33D92C)                  ; $06FA3C |
  dl hirom_mirror($33ED9E)                  ; $06FA3F |
  dl hirom_mirror($3485C4)                  ; $06FA42 |
  dl hirom_mirror($349135)                  ; $06FA45 |
  dl hirom_mirror($3497A3)                  ; $06FA48 |
  dl hirom_mirror($349CED)                  ; $06FA4B |
  dl hirom_mirror($34A35C)                  ; $06FA4E |
  dl hirom_mirror($34A8D6)                  ; $06FA51 |
  dl hirom_mirror($34AEE2)                  ; $06FA54 |
  dl hirom_mirror($34B453)                  ; $06FA57 |
  dl hirom_mirror($34B944)                  ; $06FA5A |
  dl hirom_mirror($34C110)                  ; $06FA5D |
  dl hirom_mirror($34C608)                  ; $06FA60 |
  dl hirom_mirror($34CC5F)                  ; $06FA63 |
  dl hirom_mirror($34D3A6)                  ; $06FA66 |
  dl hirom_mirror($34D905)                  ; $06FA69 |
  dl hirom_mirror($34DE25)                  ; $06FA6C |
  dl hirom_mirror($34E4A1)                  ; $06FA6F |
  dl hirom_mirror($34E952)                  ; $06FA72 |
  dl hirom_mirror($34EDE8)                  ; $06FA75 |
  dl hirom_mirror($34F36D)                  ; $06FA78 |
  dl hirom_mirror($34F994)                  ; $06FA7B |
  dl hirom_mirror($358748)                  ; $06FA7E |
  dl hirom_mirror($359257)                  ; $06FA81 |
  dl hirom_mirror($3597E0)                  ; $06FA84 |
  dl hirom_mirror($359C3D)                  ; $06FA87 |
  dl hirom_mirror($35A0EF)                  ; $06FA8A |
  dl hirom_mirror($35A75A)                  ; $06FA8D |
  dl hirom_mirror($35AD40)                  ; $06FA90 |
  dl hirom_mirror($35B189)                  ; $06FA93 |
  dl hirom_mirror($35B630)                  ; $06FA96 |
  dl hirom_mirror($35BC4D)                  ; $06FA99 |
  dl hirom_mirror($35CAD1)                  ; $06FA9C |
  dl hirom_mirror($35D992)                  ; $06FA9F |
  dl hirom_mirror($35E7A0)                  ; $06FAA2 |
  dl hirom_mirror($35F2D5)                  ; $06FAA5 |
  dl hirom_mirror($35FE28)                  ; $06FAA8 |
  dl hirom_mirror($3683C0)                  ; $06FAAB |
  dl hirom_mirror($3688CC)                  ; $06FAAE |
  dl hirom_mirror($368C94)                  ; $06FAB1 |
  dl hirom_mirror($36921D)                  ; $06FAB4 |
  dl hirom_mirror($3697A1)                  ; $06FAB7 |
  dl hirom_mirror($369A25)                  ; $06FABA |
  dl hirom_mirror($369CC2)                  ; $06FABD |
  dl hirom_mirror($36A058)                  ; $06FAC0 |
  dl hirom_mirror($36A323)                  ; $06FAC3 |
  dl hirom_mirror($36A5DB)                  ; $06FAC6 |
  dl hirom_mirror($36A78F)                  ; $06FAC9 |
  dl hirom_mirror($36A8B2)                  ; $06FACC |
  dl hirom_mirror($36AA43)                  ; $06FACF |
  dl hirom_mirror($36ABAB)                  ; $06FAD2 |
  dl hirom_mirror($36AEA9)                  ; $06FAD5 |
  dl hirom_mirror($36B2B7)                  ; $06FAD8 |
  dl hirom_mirror($36B5C3)                  ; $06FADB |
  dl hirom_mirror($36B942)                  ; $06FADE |
  dl hirom_mirror($36BC69)                  ; $06FAE1 |
  dl hirom_mirror($36C0C4)                  ; $06FAE4 |
  dl hirom_mirror($36C57B)                  ; $06FAE7 |
  dl hirom_mirror($36C937)                  ; $06FAEA |
  dl hirom_mirror($36CD88)                  ; $06FAED |
  dl hirom_mirror($36D1E9)                  ; $06FAF0 |
  dl hirom_mirror($36D61D)                  ; $06FAF3 |
  dl hirom_mirror($36DA43)                  ; $06FAF6 |
  dl hirom_mirror($36DDE5)                  ; $06FAF9 |
  dl hirom_mirror($36E042)                  ; $06FAFC |
  dl hirom_mirror($36E270)                  ; $06FAFF |
  dl hirom_mirror($36E446)                  ; $06FB02 |
  dl hirom_mirror($36E718)                  ; $06FB05 |
  dl hirom_mirror($36E9A5)                  ; $06FB08 |
  dl hirom_mirror($36EC06)                  ; $06FB0B |
  dl hirom_mirror($36EDDC)                  ; $06FB0E |
  dl hirom_mirror($36F0B5)                  ; $06FB11 |
  dl hirom_mirror($36F361)                  ; $06FB14 |
  dl hirom_mirror($36F5AB)                  ; $06FB17 |
  dl hirom_mirror($36F7F0)                  ; $06FB1A |
  dl hirom_mirror($36FAA3)                  ; $06FB1D |
  dl hirom_mirror($36FB89)                  ; $06FB20 |
  dl hirom_mirror($36FD18)                  ; $06FB23 |
  dl hirom_mirror($36FEBC)                  ; $06FB26 |
  dl hirom_mirror($378070)                  ; $06FB29 |
  dl hirom_mirror($3783C7)                  ; $06FB2C |
  dl hirom_mirror($3785A0)                  ; $06FB2F |
  dl hirom_mirror($378C16)                  ; $06FB32 |
  dl hirom_mirror($378CE5)                  ; $06FB35 |
  dl hirom_mirror($378D8F)                  ; $06FB38 |
  dl hirom_mirror($378E39)                  ; $06FB3B |
  dl hirom_mirror($378F62)                  ; $06FB3E |
  dl hirom_mirror($379179)                  ; $06FB41 |
  dl hirom_mirror($3792A1)                  ; $06FB44 |
  dl hirom_mirror($3792AD)                  ; $06FB47 |
  dl hirom_mirror($3793BC)                  ; $06FB4A |
  dl hirom_mirror($3793C8)                  ; $06FB4D |
  dl hirom_mirror($3794C1)                  ; $06FB50 |
  dl hirom_mirror($379588)                  ; $06FB53 |
  dl hirom_mirror($379669)                  ; $06FB56 |
  dl hirom_mirror($379A2E)                  ; $06FB59 |
  dl hirom_mirror($379BF5)                  ; $06FB5C |
  dl hirom_mirror($379F48)                  ; $06FB5F |
  dl hirom_mirror($37A1BE)                  ; $06FB62 |
  dl hirom_mirror($37A405)                  ; $06FB65 |
  dl hirom_mirror($37A6A5)                  ; $06FB68 |
  dl hirom_mirror($37A99E)                  ; $06FB6B |
  dl hirom_mirror($37AD4E)                  ; $06FB6E |
  dl hirom_mirror($37AE23)                  ; $06FB71 |
  dl hirom_mirror($37BAC5)                  ; $06FB74 |
  dl hirom_mirror($37BE47)                  ; $06FB77 |
  dl hirom_mirror($37C472)                  ; $06FB7A |
  dl hirom_mirror($37CB3F)                  ; $06FB7D |
  dl hirom_mirror($37D161)                  ; $06FB80 |
  dl hirom_mirror($37D781)                  ; $06FB83 |
  dl hirom_mirror($37DC95)                  ; $06FB86 |
  dl hirom_mirror($37E14B)                  ; $06FB89 |
  dl hirom_mirror($37E7E6)                  ; $06FB8C |
  dl hirom_mirror($37EDDD)                  ; $06FB8F |
  dl hirom_mirror($37F3C3)                  ; $06FB92 |
  dl hirom_mirror($37F986)                  ; $06FB95 |
  dl hirom_mirror($37FCA8)                  ; $06FB98 |
  dl hirom_mirror($388892)                  ; $06FB9B |
  dl hirom_mirror($388BEA)                  ; $06FB9E |
  dl hirom_mirror($3892CD)                  ; $06FBA1 |
  dl hirom_mirror($38945A)                  ; $06FBA4 |
  dl hirom_mirror($389996)                  ; $06FBA7 |
  dl hirom_mirror($389BFA)                  ; $06FBAA |
  dl hirom_mirror($389DA2)                  ; $06FBAD |
  dl hirom_mirror($389ED3)                  ; $06FBB0 |
  dl hirom_mirror($38A4BA)                  ; $06FBB3 |
  dl hirom_mirror($38A658)                  ; $06FBB6 |
  dl hirom_mirror($38A8B0)                  ; $06FBB9 |
  dl hirom_mirror($38AA9D)                  ; $06FBBC |
  dl hirom_mirror($38B40D)                  ; $06FBBF |
  dl hirom_mirror($38B545)                  ; $06FBC2 |
  dl hirom_mirror($38BA30)                  ; $06FBC5 |
  dl hirom_mirror($38BD29)                  ; $06FBC8 |
  dl hirom_mirror($38BEDA)                  ; $06FBCB |
  dl hirom_mirror($38C37B)                  ; $06FBCE |
  dl hirom_mirror($38C711)                  ; $06FBD1 |
  dl hirom_mirror($38C90A)                  ; $06FBD4 |
  dl hirom_mirror($38D0AB)                  ; $06FBD7 |
  dl hirom_mirror($38D32C)                  ; $06FBDA |
  dl hirom_mirror($38D727)                  ; $06FBDD |
  dl hirom_mirror($38D73B)                  ; $06FBE0 |
  dl hirom_mirror($38D839)                  ; $06FBE3 |
  dl hirom_mirror($38DCA3)                  ; $06FBE6 |
  dl hirom_mirror($38DD18)                  ; $06FBE9 |
  dl hirom_mirror($38E148)                  ; $06FBEC |
  dl hirom_mirror($38E3B8)                  ; $06FBEF |
  dl hirom_mirror($38E54D)                  ; $06FBF2 |
  dl hirom_mirror($38E564)                  ; $06FBF5 |
  dl hirom_mirror($38E790)                  ; $06FBF8 |
  dl hirom_mirror($38E9A5)                  ; $06FBFB |
  dl hirom_mirror($38EC1C)                  ; $06FBFE |
  dl hirom_mirror($38EE1A)                  ; $06FC01 |
  dl hirom_mirror($38EE26)                  ; $06FC04 |
  dl hirom_mirror($38EE32)                  ; $06FC07 |
  dl hirom_mirror($38EE3E)                  ; $06FC0A |
  dl hirom_mirror($38F083)                  ; $06FC0D |
  dl hirom_mirror($38F170)                  ; $06FC10 |
  dl hirom_mirror($38F532)                  ; $06FC13 |
  dl hirom_mirror($38F782)                  ; $06FC16 |
  dl hirom_mirror($38FA54)                  ; $06FC19 |
  dl hirom_mirror($38FC40)                  ; $06FC1C |
  dl hirom_mirror($38FD9D)                  ; $06FC1F |
  dl hirom_mirror($38FFD3)                  ; $06FC22 |
  dl hirom_mirror($3984DD)                  ; $06FC25 |
  dl hirom_mirror($3984EE)                  ; $06FC28 |
  dl hirom_mirror($398653)                  ; $06FC2B |
  dl hirom_mirror($3986E9)                  ; $06FC2E |
  dl hirom_mirror($398892)                  ; $06FC31 |
  dl hirom_mirror($398A60)                  ; $06FC34 |
  dl hirom_mirror($398DA4)                  ; $06FC37 |
  dl hirom_mirror($398DC6)                  ; $06FC3A |
  dl hirom_mirror($398EF6)                  ; $06FC3D |
  dl hirom_mirror($399024)                  ; $06FC40 |
  dl hirom_mirror($3990C8)                  ; $06FC43 |
  dl hirom_mirror($399456)                  ; $06FC46 |
  dl hirom_mirror($3994CD)                  ; $06FC49 |
  dl hirom_mirror($3997A4)                  ; $06FC4C |
  dl hirom_mirror($39981D)                  ; $06FC4F |
  dl hirom_mirror($3998D3)                  ; $06FC52 |
  dl hirom_mirror($399AC1)                  ; $06FC55 |
  dl hirom_mirror($399D51)                  ; $06FC58 |
  dl hirom_mirror($39A15C)                  ; $06FC5B |
  dl hirom_mirror($39A51B)                  ; $06FC5E |
  dl hirom_mirror($39A62A)                  ; $06FC61 |
  dl hirom_mirror($39A824)                  ; $06FC64 |
  dl hirom_mirror($39ACB2)                  ; $06FC67 |
  dl hirom_mirror($39AF37)                  ; $06FC6A |
  dl hirom_mirror($39B2B0)                  ; $06FC6D |
  dl hirom_mirror($39B518)                  ; $06FC70 |
  dl hirom_mirror($39B71B)                  ; $06FC73 |
  dl hirom_mirror($39B929)                  ; $06FC76 |

; compression routine $0A8000 graphics files
  dl hirom_mirror($39BA89)                  ; $06FC79 |
  dl hirom_mirror($39C342)                  ; $06FC7C |
  dl hirom_mirror($39CB44)                  ; $06FC7F |
  dl hirom_mirror($39D671)                  ; $06FC82 |
  dl hirom_mirror($39DFC6)                  ; $06FC85 |
  dl hirom_mirror($39E630)                  ; $06FC88 |
  dl hirom_mirror($39EEE1)                  ; $06FC8B |
  dl hirom_mirror($39F376)                  ; $06FC8E |
  dl hirom_mirror($39F91E)                  ; $06FC91 |
  dl hirom_mirror($39FF0B)                  ; $06FC94 |
  dl hirom_mirror($3A84ED)                  ; $06FC97 |
  dl hirom_mirror($3A8FEB)                  ; $06FC9A |
  dl hirom_mirror($3A980F)                  ; $06FC9D |
  dl hirom_mirror($3A9FFF)                  ; $06FCA0 |
  dl hirom_mirror($3AA6DE)                  ; $06FCA3 |
  dl hirom_mirror($3AAF69)                  ; $06FCA6 |
  dl hirom_mirror($3AB51B)                  ; $06FCA9 |
  dl hirom_mirror($3ABA65)                  ; $06FCAC |
  dl hirom_mirror($3ABF7A)                  ; $06FCAF |
  dl hirom_mirror($3AC050)                  ; $06FCB2 |
  dl hirom_mirror($3AC6D0)                  ; $06FCB5 |
  dl hirom_mirror($3ACB93)                  ; $06FCB8 |
  dl hirom_mirror($3AD11D)                  ; $06FCBB |
  dl hirom_mirror($3AD7EE)                  ; $06FCBE |
  dl hirom_mirror($3ADD3A)                  ; $06FCC1 |
  dl hirom_mirror($3AE469)                  ; $06FCC4 |
  dl hirom_mirror($3AEACF)                  ; $06FCC7 |
  dl hirom_mirror($3AEC99)                  ; $06FCCA |
  dl hirom_mirror($3AEDAC)                  ; $06FCCD |
  dl hirom_mirror($3AEEA2)                  ; $06FCD0 |
  dl hirom_mirror($3AF033)                  ; $06FCD3 |
  dl hirom_mirror($3AF28B)                  ; $06FCD6 |
  dl hirom_mirror($3AF466)                  ; $06FCD9 |
  dl hirom_mirror($3AF623)                  ; $06FCDC |
  dl hirom_mirror($3AF810)                  ; $06FCDF |
  dl hirom_mirror($3AF9BB)                  ; $06FCE2 |
  dl hirom_mirror($3AFB30)                  ; $06FCE5 |
  dl hirom_mirror($3AFC85)                  ; $06FCE8 |
  dl hirom_mirror($3AFE57)                  ; $06FCEB |
  dl hirom_mirror($3B80A3)                  ; $06FCEE |
  dl hirom_mirror($3B82C8)                  ; $06FCF1 |
  dl hirom_mirror($3B845B)                  ; $06FCF4 |
  dl hirom_mirror($3B86B4)                  ; $06FCF7 |
  dl hirom_mirror($3B87F8)                  ; $06FCFA |
  dl hirom_mirror($3B8990)                  ; $06FCFD |
  dl hirom_mirror($3B8B43)                  ; $06FD00 |
  dl hirom_mirror($3B8D2D)                  ; $06FD03 |
  dl hirom_mirror($3B8E69)                  ; $06FD06 |
  dl hirom_mirror($3B8FC6)                  ; $06FD09 |
  dl hirom_mirror($3B90F8)                  ; $06FD0C |
  dl hirom_mirror($3B9242)                  ; $06FD0F |
  dl hirom_mirror($3B93BD)                  ; $06FD12 |
  dl hirom_mirror($3B952A)                  ; $06FD15 |
  dl hirom_mirror($3B969C)                  ; $06FD18 |
  dl hirom_mirror($3B98F0)                  ; $06FD1B |
  dl hirom_mirror($3B9AEC)                  ; $06FD1E |
  dl hirom_mirror($3B9C49)                  ; $06FD21 |
  dl hirom_mirror($3B9DC6)                  ; $06FD24 |
  dl hirom_mirror($3B9FFA)                  ; $06FD27 |
  dl hirom_mirror($3BA191)                  ; $06FD2A |
  dl hirom_mirror($3BA389)                  ; $06FD2D |
  dl hirom_mirror($3BA536)                  ; $06FD30 |
  dl hirom_mirror($3BA714)                  ; $06FD33 |
  dl hirom_mirror($3BA960)                  ; $06FD36 |
  dl hirom_mirror($3BAB59)                  ; $06FD39 |
  dl hirom_mirror($3BACF1)                  ; $06FD3C |
  dl hirom_mirror($3BAE74)                  ; $06FD3F |
  dl hirom_mirror($3BAFBA)                  ; $06FD42 |
  dl hirom_mirror($3BB0F3)                  ; $06FD45 |
  dl hirom_mirror($3BB321)                  ; $06FD48 |
  dl hirom_mirror($3BB48B)                  ; $06FD4B |
  dl hirom_mirror($3BB5F0)                  ; $06FD4E |
  dl hirom_mirror($3BB80E)                  ; $06FD51 |
  dl hirom_mirror($3BBA3E)                  ; $06FD54 |
  dl hirom_mirror($3BBC21)                  ; $06FD57 |
  dl hirom_mirror($3BBDC1)                  ; $06FD5A |
  dl hirom_mirror($3BBF2C)                  ; $06FD5D |
  dl hirom_mirror($3BC0DF)                  ; $06FD60 |
  dl hirom_mirror($3BC1EC)                  ; $06FD63 |
  dl hirom_mirror($3BC3EF)                  ; $06FD66 |
  dl hirom_mirror($3BC58C)                  ; $06FD69 |
  dl hirom_mirror($3BC70B)                  ; $06FD6C |
  dl hirom_mirror($3BC885)                  ; $06FD6F |
  dl hirom_mirror($3BC947)                  ; $06FD72 |
  dl hirom_mirror($3BCA3E)                  ; $06FD75 |
  dl hirom_mirror($3BCC2E)                  ; $06FD78 |
  dl hirom_mirror($3BCE2B)                  ; $06FD7B |
  dl hirom_mirror($3BCFDF)                  ; $06FD7E |
  dl hirom_mirror($3BD119)                  ; $06FD81 |
  dl hirom_mirror($3BD286)                  ; $06FD84 |
  dl hirom_mirror($3BD445)                  ; $06FD87 |
  dl hirom_mirror($3BD5FB)                  ; $06FD8A |
  dl hirom_mirror($3BD7C6)                  ; $06FD8D |
  dl hirom_mirror($3BD930)                  ; $06FD90 |
  dl hirom_mirror($3BDAF4)                  ; $06FD93 |
  dl hirom_mirror($3BDCCE)                  ; $06FD96 |
  dl hirom_mirror($3BDE10)                  ; $06FD99 |
  dl hirom_mirror($3BDFB0)                  ; $06FD9C |
  dl hirom_mirror($3BE0E8)                  ; $06FD9F |
  dl hirom_mirror($3BE1DC)                  ; $06FDA2 |
  dl hirom_mirror($3BE3A5)                  ; $06FDA5 |
  dl hirom_mirror($3BE581)                  ; $06FDA8 |
  dl hirom_mirror($3BE6E9)                  ; $06FDAB |
  dl hirom_mirror($3BE8AE)                  ; $06FDAE |
  dl hirom_mirror($3BEA53)                  ; $06FDB1 |
  dl hirom_mirror($3BEC4C)                  ; $06FDB4 |
  dl hirom_mirror($3BEDF4)                  ; $06FDB7 |
  dl hirom_mirror($3BEFCA)                  ; $06FDBA |
  dl hirom_mirror($3BF13D)                  ; $06FDBD |
  dl hirom_mirror($3BF2C3)                  ; $06FDC0 |
  dl hirom_mirror($3BF399)                  ; $06FDC3 |
  dl hirom_mirror($3BF4BE)                  ; $06FDC6 |
  dl hirom_mirror($3BF5A6)                  ; $06FDC9 |
  dl hirom_mirror($3BF70A)                  ; $06FDCC |
  dl hirom_mirror($3BF804)                  ; $06FDCF |
  dl hirom_mirror($3C83D3)                  ; $06FDD2 |
  dl hirom_mirror($3C8596)                  ; $06FDD5 |
  dl hirom_mirror($3C8750)                  ; $06FDD8 |
  dl hirom_mirror($3C8956)                  ; $06FDDB |
  dl hirom_mirror($3C8AB6)                  ; $06FDDE |
  dl hirom_mirror($3C8F30)                  ; $06FDE1 |
  dl hirom_mirror($3C96FA)                  ; $06FDE4 |
  dl hirom_mirror($3C9DD1)                  ; $06FDE7 |
  dl hirom_mirror($3CA450)                  ; $06FDEA |
  dl hirom_mirror($3CAE3F)                  ; $06FDED |
  dl hirom_mirror($3CB939)                  ; $06FDF0 |
  dl hirom_mirror($3CBE16)                  ; $06FDF3 |
  dl hirom_mirror($3CC2AC)                  ; $06FDF6 |
  dl hirom_mirror($3CCD55)                  ; $06FDF9 |
  dl hirom_mirror($3CD7A7)                  ; $06FDFC |
  dl hirom_mirror($3CDE4B)                  ; $06FDFF |
  dl hirom_mirror($3CE583)                  ; $06FE02 |
  dl hirom_mirror($3CEAAE)                  ; $06FE05 |
  dl hirom_mirror($3CF0E0)                  ; $06FE08 |
  dl hirom_mirror($3CF7FD)                  ; $06FE0B |
  dl hirom_mirror($3D829F)                  ; $06FE0E |
  dl hirom_mirror($3D9360)                  ; $06FE11 |
  dl hirom_mirror($3DA7C0)                  ; $06FE14 |
  dl hirom_mirror($3DBA21)                  ; $06FE17 |
  dl hirom_mirror($3DC639)                  ; $06FE1A |
  dl hirom_mirror($3DD157)                  ; $06FE1D |
  dl hirom_mirror($3DD7BE)                  ; $06FE20 |
  dl hirom_mirror($3DE3D2)                  ; $06FE23 |
  dl hirom_mirror($3DE999)                  ; $06FE26 |
  dl hirom_mirror($3DEC88)                  ; $06FE29 |
  dl hirom_mirror($3DF3B1)                  ; $06FE2C |
  dl hirom_mirror($3DF5DC)                  ; $06FE2F |
  dl hirom_mirror($3DF845)                  ; $06FE32 |
  dl hirom_mirror($3DFA6E)                  ; $06FE35 |
  dl hirom_mirror($3DFCD6)                  ; $06FE38 |
  dl hirom_mirror($3DFEFF)                  ; $06FE3B |
  dl hirom_mirror($3E81FE)                  ; $06FE3E |
  dl hirom_mirror($3E8576)                  ; $06FE41 |
  dl hirom_mirror($3E8922)                  ; $06FE44 |
  dl hirom_mirror($3E8BBB)                  ; $06FE47 |
  dl hirom_mirror($3E90E1)                  ; $06FE4A |
  dl hirom_mirror($3E95BA)                  ; $06FE4D |
  dl hirom_mirror($3E9960)                  ; $06FE50 |
  dl hirom_mirror($3E9D97)                  ; $06FE53 |
  dl hirom_mirror($3EA1AB)                  ; $06FE56 |
  dl hirom_mirror($3EA5FB)                  ; $06FE59 |
  dl hirom_mirror($3EA948)                  ; $06FE5C |
  dl hirom_mirror($3EACAC)                  ; $06FE5F |
  dl hirom_mirror($3EAEB0)                  ; $06FE62 |
  dl hirom_mirror($3EB352)                  ; $06FE65 |
  dl hirom_mirror($3EBA70)                  ; $06FE68 |
  dl hirom_mirror($3EC013)                  ; $06FE6B |
  dl hirom_mirror($3EC5B7)                  ; $06FE6E |
  dl hirom_mirror($3ECD68)                  ; $06FE71 |
  dl hirom_mirror($3ED485)                  ; $06FE74 |
  dl hirom_mirror($3ED5D7)                  ; $06FE77 |
  dl hirom_mirror($3ED742)                  ; $06FE7A |
  dl hirom_mirror($3ED942)                  ; $06FE7D |
  dl hirom_mirror($3EDB92)                  ; $06FE80 |
  dl hirom_mirror($3EDD48)                  ; $06FE83 |
  dl hirom_mirror($3EDF21)                  ; $06FE86 |
  dl hirom_mirror($3EE126)                  ; $06FE89 |
  dl hirom_mirror($3EE2D2)                  ; $06FE8C |
  dl hirom_mirror($3EE925)                  ; $06FE8F |
  dl hirom_mirror($3EEE88)                  ; $06FE92 |
  dl hirom_mirror($3EF25C)                  ; $06FE95 |
  dl hirom_mirror($3EF906)                  ; $06FE98 |
  dl hirom_mirror($3EFAC9)                  ; $06FE9B |
  dl hirom_mirror($3EFCE1)                  ; $06FE9E |
  dl hirom_mirror($3EFEA6)                  ; $06FEA1 |
  dl hirom_mirror($3F80B8)                  ; $06FEA4 |
  dl hirom_mirror($3F8589)                  ; $06FEA7 |
