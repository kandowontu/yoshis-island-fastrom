...
main_gusty:
  ...
  jsl $81ACF9                               ; $01AD26 | together, our set of random values is 0, 2, 4, or 6
...
.handle_level_type
  ...
  jml $918000                               ; $01B056 |/  Jump to bandit minigame
...
CODE_01B149:
  ...
  jsl $84DC28                               ; $01B16F | Init baby mario ?
  REP #$20                                  ; $01B173 |
  LDA #$0006                                ; $01B175 |
  ...
  SEP #$20                                  ; $01B18D |
  jsl $81B27B                               ; $01B18F | Init GSU buffer
  LDA #$01                                  ; $01B193 |
  STA $0B54                                 ; $01B195 |
  REP #$20                                  ; $01B198 |
  LDA #$0002                                ; $01B19A |
...
CODE_01B1F3:
  ...
  jsl $908B61                               ; $01B1F6 |/  if loadtype < 2
...
gamemode0F:
  ...
  jsl $81DE5A                               ; $01C0E6 | message box handler
...
full_egg_item:
  ...
  jsl $829AC6                               ; $01DB1D |  Setup sprite position
...
CODE_01E59A:
  ...
  jsl $808259                               ; $01E59E | init OAM buffer
